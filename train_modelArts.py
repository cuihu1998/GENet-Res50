...
if __name__ == '__main__':
    ...
    if run_distribute:
        ...
        print("====================== device %d copy end =================================\n" % (device_id))

        unzip_command = "tar -xvf %s -C %s" % (local_zip_path,local_data_url)
        os.system(unzip_command)
        print("======================= device %d unzip end =================================\n" % (device_id))


        # mox.file.remove(local_zip_path)
        print("====================== device %d remove local zip file end ===================\n" % (device_id))


    local_data_url = os.path.join(local_data_url,"imagenet_original","train")
    # create dataset
